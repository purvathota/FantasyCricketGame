...
class Ui_Evaluation(object):
    ...
    def setupUi(self, Evaluation):
        ...
        Evaluation.setStyleSheet("background-color: lightBlue")
        ...
        self.calculate.setStyleSheet("background-color: violet")
    ...
    def retranslateUi(self, Evaluation):
        ...
        self.points_label.setText(_translate("Evaluation", "Score :"))

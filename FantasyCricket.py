...
class Ui_MainWindow(object):
                ...
                if self.entername.text() not in self.teamlist:
                    for i in objcricket.fetchall():
                        if i[0] in self.playersSelectedList:
                            ...
                            cricket.commit()
                            self.k+=1
                    self.messagebox('Hurray',"Your %s Team Saved Successfully"%(self.entername.text()))
                    self.PlayersList.clear()
                    self.SelectedPlayers.clear()
                    self.playersSelectedList=[]
                    self.count_BAT=0
    ...
    def delete_team(self):
        ...
        if ok == True:
            ...
            if self.team in self.AllTeams:
                ...
                cricket.commit()
                self.messagebox('Hurray !!','Your %s Team Deleted Successfully'%(self.team))
            elif self.team not in self.AllTeams :
                self.messagebox('Warning !!',"Your %s Team doesn't exists.\n Please enter Valid Team name to Delete in 'Team Name' Section"%(self.entername.text()))
        else: pass
    ...
    # Removing and adding Players in the ListWidget from SelectedPlayers to PlayersList
...
1. Select 'New Team' in 'Manage Team' or click  Ctrl+N to create Team\n
2. Select 'Save Team' in 'Manage Team or click  Ctrl+S to Save Team\n
3. Select 'Open Team' in 'Manage Team' or click  Ctrl+O to Open Team\n
4. Select 'Delete Team' in 'Manage Team' or click  Ctrl+Q to Delete Team\n
5. Inorder to modify the Team, You can Delete that Team and re-create it\n
6. You can Directly create New Team after saving (No need to click 'New Team' Again)'''
        mess.setText(message)
        mess.setStandardButtons(QtWidgets.QMessageBox.Ok)
        mess.setStyleSheet("background-color: #E0FFFF")
        mess.setWindowIcon(QtGui.QIcon('Icons\\message.png'))
    ...
    def about(self):
        ...
        mess.setWindowTitle('Welcome to Fantasy Cricket Game')
        mess.setStyleSheet("background-color: #E0FFFF")
        message='''Hi, This is a Fantasy Cricket Game\n \a Created By Purva Thota (19BCS1804)
 \a In this game, you can Create, Open, Delete and Evaluate Teams'''
        mess.setText(message)
        mess.setStandardButtons(QtWidgets.QMessageBox.Ok)
        mess.setWindowIcon(QtGui.QIcon('Icons\\message.png'))
        font = QtGui.QFont()
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: #99bbff")
        ...
        self.entername.setStyleSheet("background-color: white")
        ...
        self.SelectedPlayers.setStyleSheet("background-color: #eeffe6")
        ...
        font.setBold(True)
        font.setWeight(75)
        self.PtsUsed_label.setFont(font)
        ...
        self.PlayersList.setStyleSheet("background-color: #eeffe6")
        ...
        font.setBold(True)
        font.setWeight(75)
        self.PtsAVL_label.setFont(font)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Purva Thota(19BCS1804) Fantasy Cricket Game"))
        self.BAT_label_2.setText(_translate("MainWindow", "<img src='Icons\\Bat.png' width=25 height=25>Batsman(BAT)"))
        self.BOW_label_2.setText(_translate("MainWindow", "<img src='Icons\\Ball.png' width=25 height=25>Bowlers(BOW)"))
        self.label_6.setText(_translate("MainWindow", "Your Selection"))
        self.teamname_label.setText(_translate("MainWindow", "Team Name :"))
        self.WK_label_2.setText(_translate("MainWindow", "<img src='Icons\\Wicket.png' width=25 height=25>Wicket-keeper(WK)"))
        ...
        self.AR_label_2.setText(_translate("MainWindow", "<img src='Icons\\Allrounder.png' width=25 height=25>AllRounders(AR)"))
